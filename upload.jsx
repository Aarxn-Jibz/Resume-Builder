        ...
        <div className="w-full max-w-[960px] flex flex-col flex-1">
          ...
          <main className="flex flex-col flex-1 items-center justify-center gap-8 py-10 text-center">
            ...
            <div className="flex flex-col items-center gap-4 mt-8">
              ...
              <a className="flex min-w-[120px] max-w-[480px] cursor-pointer items-center justify-center rounded-lg h-14 px-8 bg-primary text-background-dark text-base font-bold" href="#">
